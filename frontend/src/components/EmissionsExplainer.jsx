...
import { X, Info, Calculator, Truck, Fuel, ShieldCheck } from 'lucide-react';
...
export function EmissionsExplainer({ isOpen, onClose, vehicleType = 'heavy_truck' }) {
  ...
  return (
    <div className="fixed inset-0 z-[1000] bg-slate-950/80 backdrop-blur-md flex items-center justify-center p-4">
      <div className="glass-panel w-full max-w-2xl rounded-2xl border border-emerald-500/30 p-6 shadow-2xl relative animate-in fade-in zoom-in-95 duration-200">
        {/* Close Button */}
        <button
          onClick={onClose}
        ...
        <div className="flex items-center space-x-3 mb-4">
          ...
          <div>
            <h3 className="text-lg font-bold text-slate-100">How We Calculated This Emission Figure</h3>
        ...
        {/* Formula Box */}
        <div className="bg-slate-900/90 border border-slate-800 p-4 rounded-xl mb-4 mono-font text-xs space-y-2">
